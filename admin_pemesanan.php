                ...
                <tr>
                    ...
                    <td>
                        <?php if ($row['status'] == 'aktif'): ?>
                            <span style="color: #0b6b43; font-weight: 600;">Disetujui</span>
                        ...
                        <?php else: ?>
                            <a href="admin_setujui.php?id=<?= $row['id_pemesanan']; ?>">
                                <button class="table-btn edit" style="background:#f6ad1b;">Setujui</button>
                            </a>

                            <a href="admin_batal.php?id=<?= $row['id_pemesanan']; ?>">
